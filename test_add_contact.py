...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_empty_contact(self):
        ...
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.create_contact(wd, firstname="", lastname="", title="", company="", address="", home="", mobile="")
        self.logout(wd)

    def logout(self, wd):
        wd.find_element_by_link_text("Logout").click()

    def create_contact(self, wd, firstname, lastname, title, company, address, home, mobile):
        # fill contact form
